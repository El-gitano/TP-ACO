...
/**
 * La classe CouperEnregistrable execute une commande Couper et enregistre son Memento dans un Enregistreur
 * @see Enregistreur
 * @see Couper
...
public final class CouperEnregistrable implements CommandeEnregistrable {
	 ...
	 */
	public CouperEnregistrable(MementoCouper memento){
