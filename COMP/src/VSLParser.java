// $ANTLR 3.5 ./src/VSLParser.g 2014-11-15 11:08:45
...
public class VSLParser extends Parser {
	...
	public final VSLParser.function_return function() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: param_list, type, FUNC_KW, IDENT, statement
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final VSLParser.decl_list_return decl_list() throws RecognitionException {
		...
		try {
			...
			pushFollow(FOLLOW_decl_item_in_decl_list927);
			...
			while (true) {
				...
				case 1 :
					...
					{
					COM102=(Token)match(input,COM,FOLLOW_COM_in_decl_list930); 
					pushFollow(FOLLOW_decl_item_in_decl_list933);
		...
		try {
			...
			switch (alt25) {
				case 1 :
					...
					IDENT104=(Token)match(input,IDENT,FOLLOW_IDENT_in_decl_item952); 
				...
				case 2 :
					...
					{
					IDENT105=(Token)match(input,IDENT,FOLLOW_IDENT_in_decl_item960);  
					stream_IDENT.add(IDENT105);

					LB106=(Token)match(input,LB,FOLLOW_LB_in_decl_item962);  
					stream_LB.add(LB106);

					INTEGER107=(Token)match(input,INTEGER,FOLLOW_INTEGER_in_decl_item964);  
					stream_INTEGER.add(INTEGER107);

					RB108=(Token)match(input,RB,FOLLOW_RB_in_decl_item966);  
					stream_RB.add(RB108);
	...
	public static final BitSet FOLLOW_decl_item_in_decl_list927 = new BitSet(new long[]{0x0000000000000042L});
	public static final BitSet FOLLOW_COM_in_decl_list930 = new BitSet(new long[]{0x0000000000004000L});
	public static final BitSet FOLLOW_decl_item_in_decl_list933 = new BitSet(new long[]{0x0000000000000042L});
	public static final BitSet FOLLOW_IDENT_in_decl_item952 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_IDENT_in_decl_item960 = new BitSet(new long[]{0x0000000000040000L});
	public static final BitSet FOLLOW_LB_in_decl_item962 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_INTEGER_in_decl_item964 = new BitSet(new long[]{0x0000000010000000L});
	public static final BitSet FOLLOW_RB_in_decl_item966 = new BitSet(new long[]{0x0000000000000002L});
}
