// $ANTLR 3.5 ./src/VSLTreeParser.g 2014-11-18 20:50:51
...
public class VSLTreeParser extends TreeParser {
		...
		try {
			...
			switch (alt3) {
				...
				case 2 :
					...
					{
					match(input,VOID_KW,FOLLOW_VOID_KW_in_type246); 
					 t = Type.VOID; 
					}
					break;
	...
	public final Code3a param_list(SymbolTable symTab) throws RecognitionException {
		...
		try {
			...
			match(input,PARAM,FOLLOW_PARAM_in_param_list277); 
			if ( input.LA(1)==Token.DOWN ) {
				...
				while (true) {
					...
					case 1 :
						...
						{
						pushFollow(FOLLOW_param_in_param_list282);
						c=param(symTab);
						state._fsp--;
	...
	public final Code3a param(SymbolTable symTab) throws RecognitionException {
		...
		try {
			...
			{
			i=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_param325); 
		...
		try {
			...
			switch (alt7) {
				case 1 :
					...
					i=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_statement364); 
					match(input, Token.UP, null); 
				...
				case 2 :
					...
					{
					match(input,RETURN_KW,FOLLOW_RETURN_KW_in_statement386); 
					match(input, Token.DOWN, null); 
				...
				case 3 :
					...
					{
					match(input,PRINT_KW,FOLLOW_PRINT_KW_in_statement407); 
					match(input, Token.DOWN, null); 
				...
				case 4 :
					...
					{
					match(input,READ_KW,FOLLOW_READ_KW_in_statement428); 
					match(input, Token.DOWN, null); 
					pushFollow(FOLLOW_read_list_in_statement432);
					c=read_list(symTab);
					state._fsp--;
				...
				case 5 :
					...
					{
					match(input,IF_KW,FOLLOW_IF_KW_in_statement449); 
					match(input, Token.DOWN, null); 
					pushFollow(FOLLOW_expression_in_statement453);
					e=expression(symTab);
					state._fsp--;
				...
				case 6 :
					...
					{
					match(input,WHILE_KW,FOLLOW_WHILE_KW_in_statement484); 
					match(input, Token.DOWN, null); 
				...
				case 7 :
					...
					match(input, Token.DOWN, null); 
					i=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_statement516); 
				...
				case 8 :
					...
					{
					pushFollow(FOLLOW_block_in_statement539);
					c=block(symTab);
					state._fsp--;
		...
		try {
			...
			switch (alt8) {
				case 1 :
					...
					match(input,BLOCK,FOLLOW_BLOCK_in_block582); 
					match(input, Token.DOWN, null); 
					pushFollow(FOLLOW_declaration_in_block586);
					cDecl=declaration(symTab);
					state._fsp--;

					pushFollow(FOLLOW_inst_list_in_block591);
	...
	public final Code3a array_elem(SymbolTable symTab) throws RecognitionException {
		...
		try {
			...
			{
			match(input,ARELEM,FOLLOW_ARELEM_in_array_elem646); 
			match(input, Token.DOWN, null); 
			i=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_array_elem651); 
			pushFollow(FOLLOW_expression_in_array_elem655);
			e=expression(symTab);
			state._fsp--;
	...
	public final Code3a inst_list(SymbolTable symTab) throws RecognitionException {
		...
		try {
			...
			match(input,INST,FOLLOW_INST_in_inst_list691); 
			match(input, Token.DOWN, null); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_statement_in_inst_list696);
					c=statement(symTab);
					state._fsp--;
		...
		try {
			...
			switch (alt10) {
				case 1 :
					...
					{
					match(input,PLUS,FOLLOW_PLUS_in_expression736); 
					match(input, Token.DOWN, null); 
				...
				case 2 :
					...
					{
					match(input,MUL,FOLLOW_MUL_in_expression760); 
					match(input, Token.DOWN, null); 
				...
				case 3 :
					...
					{
					match(input,DIV,FOLLOW_DIV_in_expression784); 
					match(input, Token.DOWN, null); 
				...
				case 4 :
					...
					{
					match(input,MINUS,FOLLOW_MINUS_in_expression808); 
					match(input, Token.DOWN, null); 
				...
				case 5 :
					...
					{
					pushFollow(FOLLOW_primary_in_expression834);
					pe=primary(symTab);
					state._fsp--;
		...
		try {
			...
			switch (alt11) {
				case 1 :
					...
					{
					INTEGER1=(CommonTree)match(input,INTEGER,FOLLOW_INTEGER_in_primary860); 
				...
				case 2 :
					...
					{
					IDENT2=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_primary872); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_expression_in_argument_list911);
					e=expression(symTab);
					state._fsp--;
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_print_item_in_print_list949);
					c=print_item(symTab);
					state._fsp--;
		...
		try {
			...
			switch (alt14) {
				case 1 :
					...
					{
					s=(CommonTree)match(input,TEXT,FOLLOW_TEXT_in_print_item990); 
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_expression_in_print_item1006);
					e=expression(symTab);
					state._fsp--;
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_read_item_in_read_list1051);
					c=read_item(symTab);
					state._fsp--;
	...
	public final Code3a read_item(SymbolTable symTab) throws RecognitionException {
		...
		try {
			...
			{
			i=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_read_item1095); 
	...
	public final Code3a declaration(SymbolTable symTab) throws RecognitionException {
		...
		try {
			...
			match(input,DECL,FOLLOW_DECL_in_declaration1145); 
			match(input, Token.DOWN, null); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_decl_item_in_declaration1150);
					c=decl_item(symTab);
					state._fsp--;
	...
	public final Code3a decl_item(SymbolTable symTab) throws RecognitionException {
		...
		try {
			...
			{
			i=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_decl_item1193); 
	...
	public static final BitSet FOLLOW_VOID_KW_in_type246 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_PARAM_in_param_list277 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_param_in_param_list282 = new BitSet(new long[]{0x0000000000004008L});
	public static final BitSet FOLLOW_IDENT_in_param325 = new BitSet(new long[]{0x0000000000000002L});
	...
	public static final BitSet FOLLOW_IDENT_in_statement364 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_RETURN_KW_in_statement386 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_statement390 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_PRINT_KW_in_statement407 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_print_list_in_statement411 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_READ_KW_in_statement428 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_read_list_in_statement432 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_IF_KW_in_statement449 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_statement453 = new BitSet(new long[]{0x00002210C4008020L});
	public static final BitSet FOLLOW_statement_in_statement458 = new BitSet(new long[]{0x00002210C4008028L});
	public static final BitSet FOLLOW_statement_in_statement464 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_WHILE_KW_in_statement484 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_statement488 = new BitSet(new long[]{0x00002210C4008020L});
	...
	public static final BitSet FOLLOW_IDENT_in_statement516 = new BitSet(new long[]{0x0000000002C14208L});
	public static final BitSet FOLLOW_argument_list_in_statement520 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_block_in_statement539 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_BLOCK_in_block582 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_declaration_in_block586 = new BitSet(new long[]{0x0000400000000000L});
	public static final BitSet FOLLOW_inst_list_in_block591 = new BitSet(new long[]{0x0000000000000008L});
	...
	public static final BitSet FOLLOW_ARELEM_in_array_elem646 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_IDENT_in_array_elem651 = new BitSet(new long[]{0x0000000002C14200L});
	public static final BitSet FOLLOW_expression_in_array_elem655 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_INST_in_inst_list691 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_statement_in_inst_list696 = new BitSet(new long[]{0x00002210C4008028L});
	public static final BitSet FOLLOW_PLUS_in_expression736 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression740 = new BitSet(new long[]{0x0000000002C14200L});
	public static final BitSet FOLLOW_expression_in_expression745 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_MUL_in_expression760 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression764 = new BitSet(new long[]{0x0000000002C14200L});
	public static final BitSet FOLLOW_expression_in_expression769 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_DIV_in_expression784 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression788 = new BitSet(new long[]{0x0000000002C14200L});
	public static final BitSet FOLLOW_expression_in_expression793 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_MINUS_in_expression808 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression812 = new BitSet(new long[]{0x0000000002C14200L});
	public static final BitSet FOLLOW_expression_in_expression817 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_primary_in_expression834 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INTEGER_in_primary860 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_IDENT_in_primary872 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_expression_in_argument_list911 = new BitSet(new long[]{0x0000000002C14202L});
	public static final BitSet FOLLOW_print_item_in_print_list949 = new BitSet(new long[]{0x0000000202C14202L});
	public static final BitSet FOLLOW_TEXT_in_print_item990 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_expression_in_print_item1006 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_read_item_in_read_list1051 = new BitSet(new long[]{0x0000000000004002L});
	public static final BitSet FOLLOW_IDENT_in_read_item1095 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_DECL_in_declaration1145 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_decl_item_in_declaration1150 = new BitSet(new long[]{0x0000000000004008L});
	public static final BitSet FOLLOW_IDENT_in_decl_item1193 = new BitSet(new long[]{0x0000000000000002L});
}
